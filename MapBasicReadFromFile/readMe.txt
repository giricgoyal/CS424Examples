...
5. Copy the “MapBasicReadFromFile” folder into the “htdocs” folder in your xampp installation folder. (Your website name will be the name of the folder).
...
http://localhost/MapBasicReadFromFile/index.php

index.php is the name of the page that you want to access. index.php file is in the “MapBasicReadFromFile”.
